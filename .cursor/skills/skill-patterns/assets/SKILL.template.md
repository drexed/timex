---
name: [skill-name]
description: [Action-oriented capability description in the third person. Max 1024 characters. Include positive triggers. Do not use for [explicit negative triggers].]
---
