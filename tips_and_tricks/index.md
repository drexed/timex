...
Every strategy emits a finish event with **`outcome`**, **`elapsed_ms`**, **`strategy`**, and **`deadline_ms`**. Plug an adapter once—see [Telemetry](https://drexed.github.io/timex/telemetry/index.md)—and you get a straight answer to “what timed out, where, and how long did we burn?”
...
Full tour: [Testing](https://drexed.github.io/timex/testing/index.md).
