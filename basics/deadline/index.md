...
If wall skew looks ugly, TIMEx can **warn through telemetry** when drift beats `config.skew_tolerance_ms`. See [Configuration](https://drexed.github.io/timex/configuration/index.md) and [Telemetry](https://drexed.github.io/timex/telemetry/index.md).
